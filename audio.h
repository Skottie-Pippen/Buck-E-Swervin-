...
#define FPGA_ONCHIP_BASE      0xC8000000  /* On-chip front buffer */
#define FPGA_ONCHIP_SPAN      0x0003FFFF
#define SDRAM_BASE            0xC0000000  /* External SDRAM back buffer */
#define SDRAM_SPAN            0x03FFFFFF
#define FPGA_CHAR_BASE        0xC9000000  /* Character buffer memory */
#define FPGA_CHAR_SPAN        0x00001FFF

/* --- Lightweight Bridge (HPS-to-FPGA) --- */
#define LW_BRIDGE_BASE        0xFF200000
#define LW_BRIDGE_SPAN        0x00005000

/* --- Lightweight Peripherals (offsets from LW_BRIDGE_BASE) --- */
...
#define PIXEL_BUF_CTRL_SPAN   0x00000020
#define CHAR_BUF_CTRL_BASE    0x00003030
#define CHAR_BUF_CTRL_SPAN    0x00000020
